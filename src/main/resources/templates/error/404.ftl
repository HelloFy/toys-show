...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="/css/site/error/404.css">
    <link rel="stylesheet" type="text/css" href="/css/site/footer.css">
    <title>Toys Site Error</title>
</head>
<body class="ui">
    ...
    <div class="ui two column grid">
        <div class="row">
            <div class="ui large teal header">
                <i class="send icon"></i> 对不起，您访问的页面不存在........
            </div>
        </div>
        <div class="row">
            <div class="ui content teal header">
                404
            </div>
        </div>
        <div class="row">
        ...
        <div class="row">
            <div class="column"><button class="ui primary button">TS首页</button> </div>
            <div class="column"><button class="ui basic button">返回</button></div>
        </div>
    </div>
    <div class="ui  grid">
